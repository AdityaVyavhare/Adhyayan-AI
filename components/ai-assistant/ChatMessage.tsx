...
export interface Message {
  ...
  // Gita Counselor Fields
  audio_url?: string; // Audio guidance URL
  referenced_shlokas?: any[]; // Bhagavad Gita verses
  life_examples?: string[]; // Real-life examples
  key_teachings?: string[]; // Key teachings
  // UI flags
...
export default function ChatMessage({
  ...
  return (
    <View style={styles.aiMessageContainer}>
      ...
      {message.Need_of_manim === "YES" &&
        message.manim_video_path &&
        message.manim_video_path.startsWith("http") && (
