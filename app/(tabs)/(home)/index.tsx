        ...
        <View style={styles.header}>
          <Link href="/(tabs)/(profile)" asChild>
            <TouchableOpacity style={styles.headerLeft}>
              <Image
                source={{
                  uri: user?.avatarUrl || "https://i.pravatar.cc/150?u=User",
                }}
                style={styles.avatar}
              />
              <View>
                <Text style={styles.greetingTitle}>
                  Hi, {user?.username || user?.firstName || "Learner"}
                </Text>
        ...
        <Link href="/(tabs)/(home)/chat" asChild>
          <TouchableOpacity style={styles.searchContainer}>
            ...
            <Text style={styles.placeholderText}>
              Ask a doubt or explain a concept...
            </Text>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.quickActionsGrid}>
            {QuickActions.map((action, index) => {
              let href = "";
              if (action.label === "Scan Question")
                href = "/(tabs)/(home)/scan-question";
              else if (action.label === "Upload PDF")
                href = "/(tabs)/(home)/pdf-chat";
              else if (action.label === "Learn from YT")
                href = "/(tabs)/(home)/youtube-learning";
              else if (action.label === "Gita Counselor")
                href = "/(tabs)/(sarthi)";
              else if (action.label === "Podcast")
                href = "/(tabs)/(home)/podcast";
              else if (action.label === "Test Generation")
                href = "/(tabs)/(practice)/test-gen";
