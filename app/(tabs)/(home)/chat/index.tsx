...
export default function ChatScreen() {
  ...
  const { currentChatId, messages, loadingConversation, error, chatsByTool } = useSelector((state: RootState) => state.chat);
  ...
  const handleSendMessage = async (text: string) => {
    ...
    try {
      // Find threadId
      const allChats = [...chatsByTool.general, ...chatsByTool.pdf, ...chatsByTool.youtube];
  ...
  const loadChat = async (chatId: string) => {
    ...
    return (
      <SafeAreaView style={styles.container}>
        ...
        <LoadingComponent visible={loadingConversation} text="Loading conversation..." />
        <ErrorModal 
            visible={!!error} 
            error={error} 
        ...
        <View style={styles.contentContainer}>
              ...
              <KeyboardDock>
                  <View style={styles.inputContainer}>
                      ...
                      />
                      <TouchableOpacity
                          style={[styles.sendButton, (!inputText.trim() || isLoading || loadingConversation) && styles.disabledSend]}
